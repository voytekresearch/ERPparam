...
class ERPparam():
    ...
    def _fit_peak_guess(self, guess):
        ...
        # In rare cases, the iterative peak-finding process can yield amplitude guesses that surpass the signal max/min. If so, set the initial guess to the signal extremum
